export async function search(title) {
  return await [
    { key: "changelog", name: "The Cangelog" },
    { key: "thisamericanlife", name: "This American Life" }
  ];
}

export async function list(key) {
  if (key === "changelog") {
  } else if (key === "thisamericanlife") {
    return [];
  }
}

//https://www.podtrac.com/pts/redirect.mp3/podcast.thisamericanlife.org/podcast/638.mp3
